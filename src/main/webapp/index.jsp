...
<body>
	...
	BoardServiceImpl bs = BoardServiceImpl.getInstance();
			...
			<div class="row">
				<div class="col-lg-8 col-md-10 mx-auto">
					<div class="site-heading">
						<h1>Board List</h1>
						<span class="subheading">view all boards</span>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-8 col-md-10 mx-auto">
				<%
                for (int j = 0; j < boardTitles.length; j++) {
                	String boardTitle = boardTitles[j];
                %>
				<div class="post-preview">
					<a href="postlist.jsp?board=<%= j+1 %>">
						<h2 class="post-title"><%=boardTitle %></h2>
					</a>
				</div>
				<%
                    if (j != boardTitles.length-1) {
                    %>
				<hr />
				<%
                    }
		...
		<nav aria-label="Page navigation">
			<ul class="pagination justify-content-center">
				...
				<li class="page-item"><a class="page-link"
					href="postlist.jsp?board=<%= boardid%>&page=<%= pagenum%>"><%= pagenum%></a></li>
				<li class="page-item"><a class="page-link"
					href="postlist.jsp?board=<%= boardid%>&page=<%= pagenum+1%>"><%= pagenum+1%></a></li>
				<li class="page-item"><a class="page-link"
					href="postlist.jsp?board=<%= boardid%>&page=<%= pagenum+2%>"><%= pagenum+2%></a></li>
