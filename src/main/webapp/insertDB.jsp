	        ...
	        <div class="col-md-12 col-lg-8">
                ...
                <form class="writeForm" method="post" name="insertForm" id="insertForm" action="update.jsp">
		            ...
		            <div class="form-group">
		                ...
		                <input type="text" class="form-control" name="date" value="<%= item.getDate()%>" readonly>
		            </div>
		
		            <div class="form-group">
		              <label for="email">Title</label>
		              <input type="text" class="form-control" id="title" name="title" value="<%= item.getTitle()%>" readonly>
		            </div>
					...
					<div class="d-flex justify-content-end">
		            	<input type="submit" class="btn btn-primary" value="update" formaction="update.jsp?post=<%= thisPagePostId%>">
		            	<button type="button" class="btn btn-secondary" onclick="window.location.href='postlist.jsp?board=<%= thisPageBoardId %>'">go to list</button>
		            </div>
	            </form>
	        </div>
	    </div>
