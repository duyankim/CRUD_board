				...
				<form class="writeForm" method="post" name="writeForm">
					<div class="form-group">
						<label for="name">Name</label> <input type="text"
							class="form-control" name="author" placeholder="Your name"
							required>
					</div>
					...
					<div class="form-group">
						<label for="date">Date</label> <input type="text"
							class="form-control" name="date" placeholder="<%= currDate%>"
							readonly>
					</div>
					...
					<div class="d-flex justify-content-end">
						<input type="submit" class="btn btn-primary" value="submit"
							formaction="insertDB.jsp?post=<%= bis.newPostId()%>">
						<button type="button" class="btn btn-secondary"
							onclick="location.href='postlist.jsp?board=<%= boardid %>'">cancel</button>
					</div>
				</form>
			</div>
		</div>
