		...
		<nav aria-label="Page navigation">
			<ul class="pagination justify-content-center">
				<li class="page-item disabled"><a class="page-link"
					href="postlist.jsp?board=<%= boardid%>&page=<%=previous%>"
					tabindex="-1" aria-disabled="true">Previous</a></li>
				<li class="page-item"><a class="page-link"
					href="postlist.jsp?board=<%= boardid%>&page=<%=pagenum%>"><%= pagenum %></a>
				</li>
				<li class="page-item"><a class="page-link"
					href="postlist.jsp?board=<%= boardid%>&page=<%=pagenum+1%>"><%= pagenum+1 %></a>
				</li>
				<li class="page-item"><a class="page-link"
					href="postlist.jsp?board=<%= boardid%>&page=<%=pagenum+2%>"><%= pagenum+2 %></a>
				</li>
				<li class="page-item"><a class="page-link"
					href="postlist.jsp?board=<%= boardid%>&page=<%=next%>"
