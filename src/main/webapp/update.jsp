	        ...
	        <div class="col-md-12 col-lg-8">
                ...
                <form class="writeForm" method="post" id="updateForm">
		            ...
		            <div class="form-group">
		                ...
		                <input type="text" class="form-control" name="date" placeholder="<%= updateItem.getDate()%>" readonly>
		            </div>
					...
					<div class="d-flex justify-content-end">
		            	<input type="submit" class="btn btn-primary" value="update" formaction="insertDB.jsp?post=<%= postid %>">
		            	<input type="submit" class="btn btn-secondary" value="delete" formaction="delete.jsp?post=<%= postid %>">
		            </div>
	            </form>
	        </div>
	    </div>
